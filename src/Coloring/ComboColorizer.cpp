...
MAKE_HOOK_MATCH(ComboUIController_StartHook, &ComboUIController::Start, void,
                ComboUIController* self) {
...
void ComboColorizerHooks(Logger& logger) {
  INSTALL_HOOK(logger, ComboUIController_StartHook);
}

ColoramaInstallHooks(ComboColorizerHooks)