...
void Colorama::Coloring::Services::DefaultMenuService::ctor(
    GlobalNamespace::MenuLightsManager *lightsManager, Tweening::Tween *tween) {
  this->_lightsManager = lightsManager;
  this->_tween = tween;
}

void Colorama::Coloring::Services::DefaultMenuService::set_v_color(
...
UnityEngine::Color
Colorama::Coloring::Services::DefaultMenuService::get_v_color() {
  return this->_color;
}
...
std::reference_wrapper<ConfigUtils::ConfigValue<ConfigUtils::Color>>
Colorama::Coloring::Services::DefaultMenuService::get_v_relatedValue() {
  return std::ref(getColoramaConfig().Menu_FreeplayColor);
}

void Colorama::Coloring::Services::DefaultMenuService::SetColor(
    UnityEngine::Color color) {
  ...
  for (auto pair : colorPairs) {
	...
	if (is_inst<GlobalNamespace::SimpleColorSO *>(pair->baseColor)) {
	  auto simpleBaseColor =
	      il2cpp_utils::cast<GlobalNamespace::SimpleColorSO>(pair->baseColor);
  ...
  std::function delegateAction_1_UE_Color =
      [](UnityEngine::Color _delegateColor) {
  ...
  _tween = Tweening::ColorTween::New_ctor(
      ...
      custom_types::MakeDelegate<System::Action_1<UnityEngine::Color> *>(
          delegateAction_1_UE_Color),
      0.5f, GlobalNamespace::EaseType::Linear, 0.0f);

  _tween->onCompleted = custom_types::MakeDelegate<System::Action *>(
      delegateAction_tweenCompleted);
