...
void ColoramaFlowCoordinator::Construct(GlobalNamespace::MainFlowCoordinator *mainFlowCoordinator, InfoViewController* infoViewController) {
...
void ColoramaFlowCoordinator::DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) {
  ...
  if(firstActivation) {
    ...
    showBackButton = true;
    ProvideInitialViewControllers(_infoViewController, nullptr, nullptr, nullptr, nullptr);
  }
}
