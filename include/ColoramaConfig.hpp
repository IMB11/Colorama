...
DECLARE_CONFIG(ColoramaConfig,
               CONFIG_VALUE(progressBarConfiguration, ProgressBarConfiguration,
                            "Progress Bar Configuration", {});
               CONFIG_VALUE(energyBarConfiguration, EnergyBarConfiguration,
                            "Energy Configuration Tab", {});
               CONFIG_VALUE(comboConfiguration, ComboConfiguration,
                            "Combo Configuration Tab", {});
               CONFIG_VALUE(multiplierConfiguration, MultiplierConfig,
