...
DECLARE_CLASS_CODEGEN_ZENJECT(
    ...
    DECLARE_PRIVATE_FIELD(CampaignFlowCoordinator*, _campaignFlowCoordinator);
    ...
    DECLARE_PRIVATE_FIELD(MenuLightsPresetSO*, _defaultFailLightPreset);
    DECLARE_OVERRIDE_METHOD(
        void, Initialize,
        GET_ZENJECT_METHOD(Zenject::IInitializable::Initialize));
    DECLARE_OVERRIDE_METHOD(void, Dispose,
                            GET_ZENJECT_METHOD(System::IDisposable::Dispose));
