...
DECLARE_CLASS_CODEGEN(
    Colorama::Coloring, ProgressBarColorizer, MonoBehaviour,
    ...
    DECLARE_INSTANCE_METHOD(void, Construct,
                            SongProgressUIController* progressUIController,
                            IAudioTimeSource* audioTimeSyncController);
    DECLARE_INSTANCE_METHOD(void, Start); DECLARE_INSTANCE_METHOD(void, Update);
