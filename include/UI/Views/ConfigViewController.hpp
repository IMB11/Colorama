...
DECLARE_CLASS_CODEGEN(
    ...
    DECLARE_INSTANCE_FIELD_PRIVATE(Colorama::Coloring::MenuColorSwapper *,
                                   _menuColorSwapper);
    DECLARE_INSTANCE_FIELD_PRIVATE(Colorama::UI::PreviewViewController *,
    ...
    DECLARE_INJECT_METHOD(
        void, Inject, Colorama::Coloring::MenuColorSwapper *menuColorSwapper,
        Colorama::UI::PreviewViewController *previewViewController);
    DECLARE_INSTANCE_METHOD(void, SwitchTab, int idx);
    DECLARE_INSTANCE_METHOD(UnityEngine::GameObject *,
                            AdjustedScrollContainerObject,
                            UnityEngine::GameObject *container, bool active);
        DECLARE_INSTANCE_METHOD(void, SetupMenuTab);
    DECLARE_INSTANCE_METHOD(void, SetupEnergyTab);
    DECLARE_INSTANCE_METHOD(void, SetupProgressBarTab);
    DECLARE_INSTANCE_METHOD(void, SetupComboTab);
    DECLARE_INSTANCE_METHOD(void, SetupMultiplierTab);
