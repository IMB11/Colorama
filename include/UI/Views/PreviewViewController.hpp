...
DECLARE_CLASS_CODEGEN(Colorama::UI, PreviewViewController, HMUI::ViewController,
                      DECLARE_INSTANCE_FIELD(Colorama::Utilities::SettingsPanelObjectGrabber*, objectGrabber);
